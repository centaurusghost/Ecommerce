...
$no_of_items=0;
    ...
    echo " <script>
    static var no_of_items=0;
    </script>
    <form name='handle_everything'> <div class='container my-4'>
    <div class='row'>
        <div class='col-8 '>
            <div class='row'>
                ...
                <div class='col-sm  text-start mx-2'>
                    ...
                    <div>
                        ...
                        <div>
                            <span>Quantity</span>
                            <input type='button' value='+' name='increase_item_number' onclick='++no_of_items'></input>
                            <span id='quantity' name='qty'>
                           <script>
                           document.write(no_of_items);
                           </script>
                            </span>
                            <input type='button' value='-' name='decrease_item_number'></input>
                        </div>
